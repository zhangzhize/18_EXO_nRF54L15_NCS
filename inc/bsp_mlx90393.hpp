...
#define MLX90393_STATUS_ERROR  (0xFF) /**< Error return value (Library internal). */
...
private:
    ...
    mlx90393_gain _gain;
    mlx90393_resolution _res_x, _res_y, _res_z;
    mlx90393_filter _dig_filt;
    mlx90393_oversampling _osr;
};
